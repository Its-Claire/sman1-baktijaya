<template>
    <div class="min-h-screen bg-gray-50">
        <!-- Navbar -->
        <Navbar :nav="nav" brand-label="SMAN 1 Bakti Jaya" />
                        ...
                        <div class="card bg-primary-content shadow-xl border border-primary/20">
                            <div class="card-body">
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    ...
                                    <div class="form-control">
                                        <label class="label">
                                            <span class="label-text font-medium text-gray-700">Ekstrakurikuler</span>
                                        </label>
                                        <select v-model="formData.program.extracurricular" class="select select-bordered bg-white">
                                            <option value="">Pilih Ekstrakurikuler (Opsional)</option>
                                            <option value="PMR">PMR (Palang Merah Remaja)</option>
                                            <option value="Pramuka">Pramuka</option>
                                            <option value="Rohis">Rohis (Rohani Islam)</option>
                        ...
                        <div class="card bg-primary-content shadow-xl border border-primary/20">
                            <div class="card-body">
                                ...
                                <div class="space-y-6">
                                    <div class="form-control">
                                        <label class="label">
                                            <span class="label-text font-medium text-gray-700">Catatan Tambahan</span>
                                        </label>
                                        <textarea 
                                    ...
                                    <div class="form-control">
                                        <label class="label cursor-pointer">
                                            <span class="label-text font-medium text-gray-700">Saya setuju dengan syarat dan ketentuan pendaftaran</span>
                                            <input 
